...
public class Principal {
    ...
    private final String API_KEY = "27147180";
    ...
    private void buscarEpisodioPorSerie() {
        ...
        if(serie.isPresent()) {
            ...
            for (int i = 1; i <= serieEncontrada.getTotalTemporadas(); i++) {
                var json =
                        consumoApi.obtenerDatos(URL_BASE + serieEncontrada.getTitulo().replace(" ", "+") + "&season=" + i +
                        "&apikey=" + API_KEY);
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Escribe el nombre de la categoría que deseas buscar: ");
